...
# BEGIN: EDIT
sed -i -e "s/connectionTimeout=\"20000\"/connectionTimeout=\"40000\"" /confluence/atlassian-confluence-latest/conf/server.xml
sed -i -e "s/maxThreads=\"48\"/maxThreads=\"70\"" /confluence/atlassian-confluence-latest/conf/server.xml
# END: EDIT
